...
function useImageWithTimeout(url: any, placeholder: string, timeout = 5000) {
...
const findImageUrl = (transaction: any, chain: string) => {
...
interface transactionImageType {
	transaction: any;
	chain: string;
}
function TransactionImage({ transaction, chain }: transactionImageType) {
